...
def calculate_Q_r_by_Hadamrd_test(A, ansatz_tree, loss_type=None, backend=None, shots_budget=1024, frugal=False, tasks_num=0,
                                  shots_num=0, file_name='message.txt'):
    """

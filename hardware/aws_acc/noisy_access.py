...
"""
    Access to the AWS Braket Simulator and the Quantum Hardware with noisy model.
...
def Hadamard_test(U, alpha=1, shots=1024):
    ...
    simulator_backend = provider.get_backend("SV1")
    ...
    for layer in U:
        for i, gate in enumerate(layer):
            ...
            #     U_in_circuit.i(i)
                ...
                U_in_circuit.h(i)
            # We introduce the bit-flipping error as the noise
            U_in_circuit.rx(rot_ang_2Q, i)

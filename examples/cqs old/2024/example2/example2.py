...
"""
    An example of linear systems of equations inspired from variational quantum linear solver (VQSL).
    We simply modified the problem a little bit.
"""

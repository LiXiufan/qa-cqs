...
"""
    Focusing on reducing the error in the combination parameters optimization, we want to claim that if we preselect the
    coefficients of matrix A, the shots number could be reduced with a high accuracy.
"""

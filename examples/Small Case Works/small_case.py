...
# coeffs =  [0.7744083927379721, 0.9409283577615206, 0.37751382343723927]
# unitaries = [[['I', 'I', 'Y']], [['X', 'Z', 'Z']], [['Y', 'Y', 'Y']]]
...
plt.plot(Itr, loss_list_hadamard, 'g-', linewidth=2.5, label='Loss Function by Hadamard Tests')
plt.plot(Itr, loss_list_mat, 'r-', linewidth=2.5, label='Loss Function by Matrix Multiplication')
